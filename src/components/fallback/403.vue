...
<template>
  <svg viewBox="0 0 400 320" class="size-full">
    <defs>
      ...
      <linearGradient id="shieldGradient403" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop
          offset="100%"
          style="stop-opacity: 1"
          :style="{ 'stop-color': token.colorPrimaryHover }"
        />
      </linearGradient>
    ...
    <!-- 装饰性几何图形 -->
    <circle cx="80" cy="80" r="40" :fill="token.colorPrimary" opacity="0.08" />
    <circle cx="320" cy="240" r="30" :fill="token.colorWarning" opacity="0.08" />
    <rect
      x="330"
      y="50"
      width="20"
    ...
    <g transform="translate(120, 120)">
      <circle cx="0" cy="0" r="16" :fill="token.colorWarning" opacity="0.2" />
      <circle cx="0" cy="0" r="12" :fill="token.colorWarning" opacity="0.4" />
      <text
        x="0"
        y="4"
        text-anchor="middle"
    ...
    <g transform="translate(280, 120)">
      <circle cx="0" cy="0" r="14" :fill="token.colorError" opacity="0.2" />
      <circle cx="0" cy="0" r="10" :fill="token.colorError" opacity="0.4" />
      <text
        x="0"
        y="3"
        text-anchor="middle"
